...
### Additional Notes About the VBA_Challenge_2017/8 Files
- Since files, VBA_Challenge_2018.png and VBA_Challenge_2017.png do not include the runtime results that are referenced in the readme file they are only included in git for the challenge. 
- The files in the readme file are named to indicate which code was used for the run, the year it was run on and that they are results from the test run.  I could append VBA_Challenge but they still would need to have different names because I wanted to show the results before and after factoring. 
- If these files should be used instead w/o runtime results, I can change the readme to use them instead and only have 2. Alternatively I can name the 2 that are after refactoring as specified by the challenge and name the others "green_stocks_2017.png" "green_stocks_2017.png" but for readability and timing as this challenge is late already, I think it is better to keep all 4 files named similarly.
